    ...
    <div className={commonStyles.page}>
      <div className={aboutStyles.aboutContent}>
        <div className={aboutStyles.aboutHeader}>
          <h1 className={aboutStyles.mainTitle}>NODE BACKEND РАЗРАБОТКА</h1>
        </div>

        <div className={aboutStyles.aboutMain}>
          <h2>Что вы найдете</h2>
          <ul>
            <li>Посты про backend разработку на NODEJS</li>
            <li>Практические задания для закрепления навыков</li>
